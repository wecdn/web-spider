...
import xyz.redpaper.red.spider.wx.util.HttpClientUtils;
...
public class WordConvertUtils {
     ...
     * @throws UnsupportedEncodingException
     */
    public static S2tApi s2t(String s) throws IOException {
...
//        map.put("sign", "7809F5F458C80DF9FE48B9BCF76A8C79");
     ...
     */
    public static S2tApi tryS2t(String simplified, int num) throws IOException, InterruptedException {
        S2tApi api = new S2tApi();
        int first = num;
